        ...
        public static void Main()
        {
            try
            {
                ...
                foreach (var drive in dicDrives)
                {
                    ...
                    Console.WriteLine(string.Format("{0,30}{1,10}{2,10}{3,10}{4,10}{5,10}", "ID", "Current", "Worst", "Threshold", "Data", "Status"));
                    foreach (var attr in drive.Value.Attributes)
                    {
                        if (attr.Value.HasData)
                            Console.WriteLine(string.Format("{0,30}{1,10}{2,10}{3,10}{4,10}{5,10}", attr.Value.Attribute, attr.Value.Current, attr.Value.Worst, attr.Value.Threshold, attr.Value.Data, ((attr.Value.IsOK) ? "OK" : "")));
                    }
                    Console.WriteLine();
                    Console.WriteLine();
                    Console.WriteLine();
